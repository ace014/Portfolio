<?php
    session_start();
    $pageTitle = "Villaver's Portfolio";
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="css/personalPortfolio.css">
    </head>
    <body>
        <main>
            ...
            <section id="mainContent">
                <div class="headerContent" id="headerContent">
                    <img src="img/png/developer1.png" alt="Victor Villaver">
                    <div id="headerText">
                        <h2>Victor Brenth Symone Villaver</h2>
                        <h3>Specialty Title/Job Title</h2>
                        <h4>Skills</h4>
                        <ul>
                            <li>Skill 1</li>
                            <li>Skill 2</li>
                ...
                <div id="bodyContent">
                    <div id="tabs">
                        <div class="tab active">About Me</div>
                        <div class="tab">My Education</div>
                        <div class="tab">My Projects</div>
                    </div>
                    <hr>
                    <div id="bodySlider">
                        <div class="slide">
                        ...
                        <div class="slide">
                            <div class="collage">
                                ...
                                <div class="collage-item">
                                    <img src="img/png/homeCarou3.png" alt="Project 3">
                                    <div class="overlay">
                                        <h2>Project 3 Title</h2>
                                    </div>
                                </div>
                                <div class="collage-item">
                                    <img src="img/png/homeCarou4.png" alt="Project 4">
                                    <div class="overlay">
                                        <h2>Project 4 Title</h2>
                                    </div>
                                </div>
                                <div class="collage-item">
                                    <img src="img/png/homeCarou5.png" alt="Project 5">
                                    <div class="overlay">
        ...
        <script>
          document.addEventListener("DOMContentLoaded", function() {
            ...
            headerContent.appendChild(particlesDiv);
        ...
        <script>
          document.addEventListener("DOMContentLoaded", function() {
            ...
            const slider = document.getElementById("bodySlider");
